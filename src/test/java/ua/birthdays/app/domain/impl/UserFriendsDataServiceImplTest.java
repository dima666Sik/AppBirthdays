...
class UserFriendsDataServiceImplTest {
    ...
    void createUserFriendsData() {
        ...
        boolean isCreatedUser = userFriendsDataService.createUserFriendsData(userFriendsData);
    ...
    void createFriendBirthdayDate() {
        ...
        boolean isCreated = userFriendsDataService.createFriendBirthdayDate(friendBirthdayDate);
    ...
    void createAboutFriend() {
        ...
        boolean isCreated = userFriendsDataService.createAboutFriend(aboutFriend);
        Assertions.assertTrue(isCreated);
    }
    ...
    void readAllUserFriendsData() {
        ...
        List<UserFriendsData> userFriendsDataList = userFriendsDataService.readAllUserFriendsDataByDefault(user);
