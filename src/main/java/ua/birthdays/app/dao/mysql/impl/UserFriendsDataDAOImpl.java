...
import ua.birthdays.app.dao.util.ReadId;
 ...
 */
public class UserFriendsDataDAOImpl implements UserFriendsDataDAO {
    private static final Logger logger = LogManager.getLogger(UserFriendsDataDAOImpl.class.getName());
    ...
    private void readByIdUserUserFriendData(User user, PreparedStatement statement) throws SQLException {
        statement.setLong(1, ReadId.readIdUser(user.getEmail(), user.getPassword()));
    ...
    public boolean updateUserFriendsData(final UserFriendsData oldUserFriendsData,
        ...
        try (var connection = DBConnector.getConnection();
            ...
            statement.setString(6, newUserFriendsData.getAboutFriend()
                                                     .getNameFriend());
            statement.setLong(7, ReadId.readIdFriendsDataRowByIdUserAndFriendNameAndDateFriendBirthday(idUser, oldUserFriendsData.getAboutFriend()
    ...
    public boolean deleteUserFriendsData(final UserFriendsData userFriendsData) {
        ...
        try (var connection = DBConnector.getConnection();
            ...
            statement.setLong(1, ReadId.readIdFriendsDataRowByIdUserAndFriendNameAndDateFriendBirthday(idUser, userFriendsData.getAboutFriend()
