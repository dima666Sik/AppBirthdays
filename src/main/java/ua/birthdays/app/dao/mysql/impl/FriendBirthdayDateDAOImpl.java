 ...
 */
public class FriendBirthdayDateDAOImpl implements FriendBirthdayDateDAO {
    private static final Logger logger = LogManager.getLogger(FriendBirthdayDateDAOImpl.class.getName());
