...
public class EditUserFriendBirthdayView extends JDialog {
    ...
    private void editUserFriendBirthday(UserFriendsData userFriendsData) {
        ...
        if (jDateChooser.getDate()
                        .toInstant()
                        .atZone(
                                ZoneId.systemDefault())
                        .toLocalDate()
                        .isEqual(userFriendsData.getFriendBirthdayDate()
                                                .getFriendDate()) &&
                textFieldFriendName.getText()
                                   .equals(userFriendsData.getAboutFriend()
                                                          .getNameFriend()) &&
                Integer.parseInt(textFieldRemindingHour.getText()) == userFriendsData.getFriendBirthdayDate()
                                                                                     .getRemindedFriendHour() &&
                Integer.parseInt(textFieldRemindingMinutes.getText()) == userFriendsData.getFriendBirthdayDate()
                                                                                        .getRemindedFriendMinutes() &&
                Integer.parseInt(textFieldRemindingCountDaysBeforeBirthday.getText()) == userFriendsData.getFriendBirthdayDate()
                                                                                                        .getRemindedCountDaysBeforeBirthday()
        ) {
